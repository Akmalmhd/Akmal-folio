...
const Contact = () => {
    ...
    const access_key1 = process.env.NEXT_PUBLIC_ACCESS_KEY;
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", access_key1);
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      onSubmit={onSubmit} action="" className='max-w-2xl mx-auto'>
        ...
        type='submit' 
        className="py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover">Send message <Image src={assets.right_arrow_white} alt='arrow' className='w-4' /></motion.button>
